...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MonitoringAndEvaluationApp.Android.dll" comes first in this list. */
		"MonitoringAndEvaluationApp.Android.dll",
		"FormsViewGroup.dll",
		"MonitoringAndEvaluationApp.dll",
		"SQLite-net.dll",
